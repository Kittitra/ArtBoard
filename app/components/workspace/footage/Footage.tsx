...
const Footage = ({ data, moviePath, projectId, user}: Props) => {
      ...
      {step === "form" && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-2xl shadow-2xl p-8 flex flex-col gap-5 w-96">
            <h3 className="font-semibold text-gray-700">New Footage</h3>
                      ...
                      <div className='flex flex-row gap-10 w-full h-fit justify-start items-center bg-white p-5'>
                        ...
                        <div className=' justify-end-safe m-auto'>
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent>
                              <DropdownMenuGroup>
                                  <Link href={`http://localhost:3000/auth/project/${projectId}/footages/${moviePath}/${item.id}`} >
                                    <DropdownMenuItem>
                                        View
                                    </DropdownMenuItem>
                                  </Link>
